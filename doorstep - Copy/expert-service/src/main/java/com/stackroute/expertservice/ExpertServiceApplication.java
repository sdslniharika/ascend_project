    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .components(new Components()
                        .addSecuritySchemes(ExpertConstants.HEADER_AUTHORIZATION, new SecurityScheme()
                                .type(SecurityScheme.Type.APIKEY)
                                .in(SecurityScheme.In.HEADER)
                                .name(ExpertConstants.HEADER_AUTHORIZATION)))
                .addSecurityItem(new SecurityRequirement().addList(ExpertConstants.HEADER_AUTHORIZATION));
    }
